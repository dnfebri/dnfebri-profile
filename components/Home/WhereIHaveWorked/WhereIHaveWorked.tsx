        ...
        <div className="flex flex-row md:flex-col ">
          {COMPANY_BUTTON.map((cBtn, idx) => (
            <CompanyButton
              ...
              CompanyName={cBtn.companyName}
              BarPosition={cBtn.barPosition}
              BarAvobePosition={cBtn.barAvobePosition}
              DescriptionJob={cBtn.descriptionJob}
              CompanyNameBackgroundColorGreen={cBtn.backgroundActive}
